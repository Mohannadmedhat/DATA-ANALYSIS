    ...
    <div className="flex flex-col justify-between w-full h-full max-w-6xl mx-auto py-1 select-none text-slate-900">
            ...
            return (
              <button
                ...
                className={`relative px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all duration-300 cursor-pointer ${
                  isSelected 
                    ? 'text-amber-700 font-black shadow-sm' 
      ...
      <div className="flex-1 flex items-stretch my-auto">
        <AnimatePresence mode="wait">
          {/* VIEW 1: THREE PILLARS (Exact match to Slide 29 of PDF) */}
          {activeTab === 'overview' && (
            <motion.div
              key="overview"
              initial={{ opacity: 0 }}
            ...
            >
              ...
              <motion.div
                ...
                whileHover={{ y: -3 }}
                className="flex flex-col justify-between p-5 rounded-2xl border border-amber-200 bg-white shadow-sm hover:shadow-md transition-all text-start"
              >
                <div>
              ...
              <motion.div
                ...
                whileHover={{ y: -3 }}
                className="flex flex-col justify-between p-5 rounded-2xl border border-emerald-200 bg-white shadow-sm hover:shadow-md transition-all text-start"
              >
                <div>
                  <div className="flex items-center justify-between mb-3.5">
                    <div className="w-10 h-10 rounded-xl bg-emerald-50 border border-emerald-100 text-emerald-600 flex items-center justify-center font-black shadow-sm">
          ...
          {activeTab === 'etl' && (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              className="flex flex-col justify-between w-full h-full p-5 sm:p-6 rounded-2xl border border-amber-200 bg-white shadow-sm text-start"
            >
              <div>
                <div className="flex items-center justify-between mb-3.5">
                  <div className="flex items-center gap-2">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          <span className={`text-xs font-bold ${isSelected ? 'text-amber-700' : 'text-slate-800'}`}>
                            {step.title}
                          </span>
                          {step.id <= activeStep && <Check className="w-3.5 h-3.5 text-emerald-600" />}
                        </div>
                ...
                <div className="p-4 bg-slate-900 rounded-xl text-slate-200 font-mono text-xs shadow-inner">
              ...
              <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500">
                ...
                <span className="font-mono text-amber-600 font-bold">100% No Manual Excel Redo</span>
              </div>
            </motion.div>
          )}
          ...
          {activeTab === 'star-schema' && (
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-3 bg-blue-50/70 border border-blue-200 rounded-xl text-xs">
                      <div className="flex items-center justify-between font-bold text-blue-900 mb-1">
                        ...
                        <span className="font-mono text-[10px] bg-blue-200 text-blue-800 px-1 rounded">1</span>
                      </div>
                      <span className="text-[10px] text-slate-600 font-mono block">PK: CustomerKey • Name • Segment</span>
                    </div>
                    ...
                    <div className="p-3 bg-indigo-50/70 border border-indigo-200 rounded-xl text-xs">
                      <div className="flex items-center justify-between font-bold text-indigo-900 mb-1">
                        ...
                        <span className="font-mono text-[10px] bg-indigo-200 text-indigo-800 px-1 rounded">1</span>
                      </div>
                      <span className="text-[10px] text-slate-600 font-mono block">PK: DateKey • Year • Month • Qtr</span>
                    </div>
                  </div>

                  {/* Center: Central Fact_Sales */}
                  <div className="p-4 bg-amber-500 text-white rounded-2xl shadow-md text-center border-2 border-amber-600">
                    ...
                    <span className="text-[11px] font-mono bg-amber-600/60 px-2 py-0.5 rounded inline-block">
                      Cardinality: Many (*)
                    </span>
                    <div className="mt-2 text-[10px] text-amber-100 font-mono space-y-0.5 border-t border-amber-400/40 pt-1.5 text-start">
                  ...
                  <div className="p-3 bg-emerald-50/70 border border-emerald-200 rounded-xl text-xs">
                    <div className="flex items-center justify-between font-bold text-emerald-900 mb-1">
                      ...
                      <span className="font-mono text-[10px] bg-emerald-200 text-emerald-800 px-1 rounded">1</span>
                    </div>
                    <span className="text-[10px] text-slate-600 font-mono block">PK: ProductKey • Category • UnitCost</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500">
                ...
                <span className="font-mono text-blue-600 font-bold">1-to-Many Relationships</span>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
