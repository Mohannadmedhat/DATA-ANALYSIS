            ...
            >
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Table 1: Customers */}
                  <div className="border border-slate-800 rounded-xl overflow-hidden shadow-xs bg-slate-950/60">
                    <div className="bg-blue-900/80 text-white px-3 py-2 text-xs font-bold flex items-center justify-between border-b border-blue-800">
                      <span className="flex items-center gap-1.5">
                        <Table className="w-3.5 h-3.5" />
                        TABLE: Customers (Parent)
                      </span>
                      <span className="text-[10px] bg-blue-950 px-1.5 py-0.5 rounded font-mono text-blue-200">
                        PK: customer_id
                      </span>
                    </div>
                    <table className="w-full text-xs">
                      <thead className="bg-slate-900 text-[11px] text-slate-400 font-mono border-b border-slate-800">
                        <tr>
                          ...
                          return (
                            <tr
                              ...
                              className={`cursor-pointer transition-colors ${
                                isHovered ? 'bg-blue-900/50 text-white font-bold' : 'hover:bg-slate-900/60 text-slate-300'
                              }`}
                            >
                              <td className="py-2 px-3 font-mono text-blue-400 font-bold flex items-center gap-1">
                                <Key className="w-3 h-3 text-amber-400" />
                                {c.id}
                              </td>
                              <td className="py-2 px-3">{c.name}</td>
                              <td className="py-2 px-3 text-slate-400">{c.city}</td>
                            </tr>
                          );
                        })}
                      </tbody>
                  ...
                  {/* Table 2: Orders */}
                  <div className="border border-slate-800 rounded-xl overflow-hidden shadow-xs bg-slate-950/60">
                    <div className="bg-indigo-900/80 text-white px-3 py-2 text-xs font-bold flex items-center justify-between border-b border-indigo-800">
                      <span className="flex items-center gap-1.5">
                        <Table className="w-3.5 h-3.5" />
                        TABLE: Orders (Child)
                      </span>
                      <span className="text-[10px] bg-indigo-950 px-1.5 py-0.5 rounded font-mono text-indigo-200">
                        FK: customer_id
                      </span>
                    </div>
                    <table className="w-full text-xs">
                          ...
                          return (
                            <tr
                              ...
                              className={`transition-colors ${
                                isHighlighted ? 'bg-indigo-900/50 text-white font-bold' : 'hover:bg-slate-900/60 text-slate-300'
                              }`}
                            >
                              <td className="py-2 px-3 font-mono text-slate-300">#{o.orderId}</td>
                              <td className="py-2 px-3 font-mono text-indigo-400 font-bold flex items-center gap-1">
                                <Link2 className="w-3 h-3 text-indigo-400" />
                                {o.customerId}
                              </td>
                              <td className="py-2 px-3 text-slate-400 font-mono text-[11px]">{o.date}</td>
                              <td className="py-2 px-3 font-mono font-bold text-emerald-400">{o.total}</td>
                            </tr>
                          );
                        })}
                      </tbody>
              ...
              <div className="mt-3 pt-2.5 border-t border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-[11px] text-slate-400">
