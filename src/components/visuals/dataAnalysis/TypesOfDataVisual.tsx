...
export const TypesOfDataVisual: React.FC<TypesOfDataVisualProps> = ({ isRTL }) => {
  ...
  return (
    <div className="flex flex-col justify-between w-full h-full max-w-6xl mx-auto py-1 select-none text-slate-900">
      {/* Top Filter Tabs Bar — Clean Light Style */}
      ...
      {/* Main Content Area with Slow Gentle Staggered Float-In Animation (matching Slide 2) */}
      <div className="flex-1 flex items-stretch my-auto">
        <AnimatePresence mode="wait">
          {/* TAB 1: ALL TYPES (Side-by-Side Unified Comparison) */}
          {activeTab === 'all' && (
            <motion.div
              key="all"
              initial={{ opacity: 0 }}
            ...
            >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                    ...
                    <div className="p-3.5 rounded-xl bg-slate-50/80 border border-slate-200/80">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        <span className="px-2 py-0.5 rounded bg-white border border-slate-200 text-[10px] text-cyan-800 font-semibold">
                    ...
                    <div className="p-3.5 rounded-xl bg-slate-50/80 border border-slate-200/80">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        <span className="px-2 py-0.5 rounded bg-white border border-slate-200 text-[10px] text-blue-800 font-semibold">
              ...
              {/* Quantitative Pillar — Light Card */}
              <motion.div 
                initial={{ opacity: 0, y: 22 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.22, ease: 'easeOut' }}
                whileHover={{ y: -3 }}
                className="flex flex-col justify-between p-5 sm:p-6 rounded-2xl border border-amber-100 bg-white shadow-sm hover:shadow-md hover:border-amber-200 transition-all text-start"
              >
                <div>
                  <div className="flex items-center justify-between mb-3.5">
                    <div className="flex items-center gap-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                    ...
                    <div className="p-3.5 rounded-xl bg-slate-50/80 border border-slate-200/80">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        <span className="px-2 py-0.5 rounded bg-white border border-slate-200 text-[10px] text-amber-800 font-semibold">
                    ...
                    <div className="p-3.5 rounded-xl bg-slate-50/80 border border-slate-200/80">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        <span className="px-2 py-0.5 rounded bg-white border border-slate-200 text-[10px] text-orange-800 font-semibold">
                ...
                <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500 font-medium">
                  ...
                  <span className="text-amber-600 font-bold">Numerical</span>
                </div>
              </motion.div>
            </motion.div>
          )}

          {/* TAB 2: QUALITATIVE DEEP-DIVE (Light Style) */}
          {activeTab === 'qual' && (
            <motion.div
              key="qual"
              initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto py-3">
                ...
                >
                  ...
                  <div className="p-3 rounded-lg bg-white border border-slate-200 text-xs text-slate-700">
                    <span className="text-blue-600 font-bold block mb-1">{isRTL ? '💡 أمثلة شائعة في العمل:' : '💡 Common Enterprise Examples:'}</span>
                    {isRTL 
              ...
              >
                ...
                <span className="text-blue-600 font-bold">Qualitative Analysis</span>
              </motion.div>
            </motion.div>
          )}

          {/* TAB 3: QUANTITATIVE DEEP-DIVE (Light Style) */}
          {activeTab === 'quant' && (
            <motion.div
              key="quant"
              initial={{ opacity: 0 }}
              ...
              exit={{ opacity: 0 }}
              transition={{ duration: 0.3 }}
              className="w-full h-full p-6 sm:p-7 rounded-2xl border border-amber-100 bg-white shadow-sm flex flex-col justify-between text-start"
            >
              <motion.div 
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="flex items-center gap-3.5">
                  <div className="p-3 rounded-xl bg-amber-50 border border-amber-100 text-amber-600 shadow-sm">
                ...
                <span className="px-3 py-1 rounded-lg bg-amber-50 border border-amber-100 text-amber-700 text-xs font-bold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-auto py-3">
                ...
                >
                  ...
                  <div className="p-3 rounded-lg bg-white border border-slate-200 text-xs text-slate-700">
                    <span className="text-amber-600 font-bold block mb-1">{isRTL ? '💡 أمثلة شائعة في العمل:' : '💡 Common Enterprise Examples:'}</span>
                    {isRTL 
                ...
                >
                  ...
                  <div className="p-3 rounded-lg bg-white border border-slate-200 text-xs text-slate-700">
                    <span className="text-orange-600 font-bold block mb-1">{isRTL ? '💡 أمثلة شائعة في العمل:' : '💡 Common Enterprise Examples:'}</span>
                    {isRTL 
              ...
              >
                ...
                <span className="text-amber-600 font-bold">Quantitative Analysis</span>
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
